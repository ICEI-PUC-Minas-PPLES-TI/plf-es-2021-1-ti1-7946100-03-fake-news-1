const db = {
  dados: [
    {
      id: 0,
      header: 'Notícia Pesquisada',
      categoria: 'Categoria: coronavirus',
      titulo: 'Transmissão da COVID tem terceira alta seguida em BH após Dia das Mães',
      imagem: "img/covid.jpg",
      conteudo: [
        ...
        'O crescimento considerável começou exatamente após os 14 dias do domingo dedicado às genitoras. Vale lembrar que esse prazo é a janela de infecção do vírus, portanto só nesta semana se pode analisar, de fato, o impacto da data comemorativa na pandemia. No patamar atual, cada 100 infectados com a COVID-19 em BH transmitem a doença, em média, para 108 pessoas. O dado está dentro da zona de alerta da escala de risco, entre 1 e 1,2.',
        'Na comparação com o boletim anterior, houve leve alta, já que o indicador estava em 1,05 nessa segunda (24/5). Outro indicador fundamental da pandemia, a taxa de ocupação dos leitos de enfermaria para pacientes com COVID-19 também sofreu alta: de 62,4% para 63,8%.',
        'Casos e mortes:',
    ...
    },
    {
      id: 1,
      header: 'Notícia Pesquisada',
      categoria: 'Categoria: política',
      titulo: 'Em velório lotado, Almi é lembrado pelo jeito agregador de fazer política',
      imagem: "img/politica.webp",
      conteudo: [
    ...
    },
    {
      ...
      titulo: 'Hamilton admite que será difícil bater Red Bull, mas ressalta: "Não acabou"',
    ...
    },
    {
      id: 3,
      header: 'Notícia Pesquisada',
      categoria: 'Categoria: entreterimento',
      titulo: 'Marcos Oliveira, o Beiçola de ‘A Grande Família’, diz que recebe ajuda para comprar comida',
      imagem: "img/entreterimento.jpg",
      conteudo: [
